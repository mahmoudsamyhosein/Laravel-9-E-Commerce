<div dir="rtl" style="text-align: right">
    <title>@section('title','تعديل الكوبون | ')</title>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6 pull-right">
                                <h4>{{__('mshmk.Edit_Coupon')}}</h4>
                            </div>
                            <div class="col-md-6">
                                <a href="{{route('admin.coupons')}}" class="btn btn-success pull-left">{{__('mshmk.All_Coupon')}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateCoupon">
                            <div class="form-group">
                                <label class="col-md-4 control-label">{{__('mshmk.Coupon_Code')}}</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">{{__('mshmk.Coupon_Type')}}</label>
                                <div class="col-md-4">
                                    <select class="form-control" wire:model="type">
                                        <option value="">{{__('mshmk.Select')}}</option>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">{{__('mshmk.Coupon_Value')}}</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">{{__('mshmk.Cart_Value')}}</label>
                                <div class="col-md-4">

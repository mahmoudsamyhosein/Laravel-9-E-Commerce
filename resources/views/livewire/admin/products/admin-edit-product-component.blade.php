            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                @endif
                                <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent='updateProduct' dir="rtl">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4" wire:ignore>
                                            <textarea type="text" placeholder="{{__('mshmk.Short_Description')}}" id="short_description" class="form-control" wire:model='short_description'></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4" wire:ignore>
                                            <textarea type="text" placeholder="{{__('mshmk.Description')}}" id="description" class="form-control" wire:model='description'></textarea>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">{{__('mshmk.Product_Attributes')}}</label>
                                            ...
                                            <div class="col-md-4" >
                                                <button type="button" class="btn btn-info" style="margin-left:200px;" wire:click.prevent="add">
                                                    {{__('mshmk.Add')}}
                                                </button>
                                            </div>
                                    </div>

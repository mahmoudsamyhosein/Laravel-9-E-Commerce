        ...
        <div class="row">
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{$totalRevenue}} {{ $setting->currency}}</span>
                  </div>   
            ...
            <div class="col-md-3 col-sm-6">    
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    <span class="icon-stat-label text-right" >{{__('mshmk.Total_Sales')}}</span>
            ...
            <div class="col-md-3 col-sm-6">    
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    <span class="icon-stat-label text-right">{{__('mshmk.Today_Revenue')}}</span>
                    <span class="icon-stat-value">{{$todayRevenue}} {{ $setting->currency}}</span>
                  </div>    
                  <div class="col-xs-4 text-center">
                    <i class="fa fa-dollar icon-stat-visual bg-primary"></i>
                  </div>
            ...
            <div class="col-md-3 col-sm-6">    
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    <span class="icon-stat-label text-right">{{__('mshmk.Today_Sales')}}</span>
